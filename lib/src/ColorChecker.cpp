...
bool ColorChecker::isUniformColor(const unsigned char* imageData, int imageWidth, 
                                 int x, int y, int width, int height, uint32_t& color) const {
...
bool ColorChecker::isUniformColor(const unsigned char* imageData, int imageWidth, 
    ...
    uint32_t dummyColor;
    return isUniformColor(imageData, imageWidth, x, y, width, height, dummyColor);
}

uint32_t ColorChecker::getPixelColor(const unsigned char* imageData, int imageWidth, int x, int y) const {
...
bool ColorChecker::isValidCoordinate(int imageWidth, int imageHeight, int x, int y) const {
