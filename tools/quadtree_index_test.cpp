...
int main() {
    ...
    cout << "  - 地图尺寸: " << normalIndex.getMapWidth() << "x" << normalIndex.getMapHeight() << endl;
    ...
    cout << "  - 地图尺寸: " << qtIndex.getMapWidth() << "x" << qtIndex.getMapHeight() << endl;
    ...
    for (const auto& vp : testViewports) {
        ...
        cout << "    - 普通索引: " << normalQueryTime << " 微秒, " << normalResult.size() << " 瓦片" << endl;
        cout << "    - 四叉树索引: " << qtQueryTime << " 微秒, " << qtResult.size() << " 瓦片" << endl;
